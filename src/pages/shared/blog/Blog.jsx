...
const Blog = () => {
    return (
        <div className='container mx-auto'>
            ...
            <div>
                <h3 className='text-xl font-bold text-center mb-3'>1.The main different between controlled and uncontrolled components.</h3>
                <p className='text-center mb-3'>A Controlled Component is one that takes its current value through props and notifies changes through callbacks like onChange.
                ...
                <h3 className='text-xl font-bold text-center mb-3'>2.React props validate using PropTypes</h3>
                <p className='text-center'>i.any : The prop can be of any data type. <br />
